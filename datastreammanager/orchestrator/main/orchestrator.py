...
#         return zookeeper_hostport
    ...
    def start_evaluator(self):
        if self.config.newsreel == True:
            ...
            command = "/vagrant/evaluator/spark-streaming/run.sh {recommendation_results_topic}".format(recommendation_results_topic=self.config.recommendation_results_topic)
