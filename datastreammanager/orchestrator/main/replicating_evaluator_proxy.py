...
class ReplicatingEvaluatorProxy():
    ...
    def feed_file_to_topic(self, input_file_name, topic_name, conf_file_suffix):
    ...
    def start_input_feed(self, input_file_name):
        ...
        self.feed_file_to_topic(input_file_name, self.environment.input_topic, "input")
        self.feed_file_to_topic(input_file_name, self.environment.recommendation_requests_topic, "rec-requests")
        self.feed_file_to_topic(input_file_name, self.environment.ground_truth_topic, "ground-truth")
